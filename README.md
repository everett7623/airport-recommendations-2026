...
| 💰 预算有限（学生党） | 入门经济 | ¥3-10/月 | 新华云、SKYLUMO | [查看详情](#-入门经济型) |
| ⚡ 日常使用（看剧、办公） | 性价比均衡 | ¥15-30/月 | 光速云、光年梯 | [查看详情](#️-性价比均衡) |
| 🎬 4K流媒体观影 | 性价比均衡 | ¥15-30/月 | 飞猫云、SsrDog | [查看详情](#️-性价比均衡) |
...
| 飞猫云 | IEPL/IPLC | ¥15/月 | 1倍 | ✅ | ✅ | `游戏` `极速` | ⭐⭐⭐⭐⭐ |
| 全球云 | IEPL/IPLC | ¥20/月 | 1倍 | ✅ | ✅ | `流媒体` `极速` | ⭐⭐⭐⭐⭐ |
...
| Dler Cloud | BGP/IEPL | ¥299/年 | 1倍 | ✅ | ✅ | `墙洞` `老牌` | ⭐⭐⭐⭐⭐ |
| MESL | Premium | ¥50/月 | 1倍 | ✅ | ✅ | `低调` `顶级` | ⭐⭐⭐⭐⭐ |
| ImmTelecom | IEPL/IPLC | ¥50/月 | 1倍 | ✅ | ✅ | `电信` `高端` | ⭐⭐⭐⭐⭐ |
| AmyTelecom | IEPL | ¥30/月 | 1倍 | ✅ | ✅ | `佩奇系` `流媒体` | ⭐⭐⭐⭐⭐ |
| Kuromis | IEPL | ¥34/月 | 1倍 | ✅ | ✅ | `库洛米` `高性能` | ⭐⭐⭐⭐⭐ |
